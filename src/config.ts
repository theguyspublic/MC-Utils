export default {
  ...
  db: {
    mongoURI: "mongodb+srv://mcutils:mcutils@hypers-utilities.dqsni.mongodb.net/",
  },
  channels: {
    modLogChannel: "799447102794367012",
    logChannel: "863505832846557194",
    botCmdChannel: "848550393264865290",
  },
  mainGuildId: "799443569848745984",
  roles: {
    muteRole: "800203816376860712",
    managerRoles: [
      "799445133368098858",
    ],
  },
